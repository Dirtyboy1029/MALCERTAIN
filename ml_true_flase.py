...
if __name__ == '__main__':
    ...
    if experiment_type == "train":
        ...
        if PN:
            clf_svm = joblib.load(
                'D:\\Pycharm\\Project\\malware-uncertainty\\myexperiment\\ml_model\\PN\\svm_' + test_model_type + '.pkl')
            clf_knn = joblib.load(
                'D:\\Pycharm\\Project\\malware-uncertainty\\myexperiment\\ml_model\\PN\\knn_' + test_model_type + '.pkl')
            clf_dt = joblib.load(
                'D:\\Pycharm\\Project\\malware-uncertainty\\myexperiment\\ml_model\\PN\\dt_' + test_model_type + '.pkl')
            clf_RF = joblib.load(
                'D:\\Pycharm\\Project\\malware-uncertainty\\myexperiment\\ml_model\\PN\\rf_' + test_model_type + '.pkl')
        else:
            clf_svm = joblib.load(
                'D:\\Pycharm\\Project\\malware-uncertainty\\myexperiment\\ml_model\\not_PN\\svm_' + test_model_type + '.pkl')
            clf_knn = joblib.load(
                'D:\\Pycharm\\Project\\malware-uncertainty\\myexperiment\\ml_model\\not_PN\\knn_' + test_model_type + '.pkl')
            clf_dt = joblib.load(
                'D:\\Pycharm\\Project\\malware-uncertainty\\myexperiment\\ml_model\\not_PN\\dt_' + test_model_type + '.pkl')
            clf_RF = joblib.load(
                'D:\\Pycharm\\Project\\malware-uncertainty\\myexperiment\\ml_model\\not_PN\\rf_' + test_model_type + '.pkl')
